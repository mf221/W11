...
public class Author extends Person {
    ...
    //if the number of books written is 0, logically this person cannot be an author so
    //wouldn't exist in this class, therefore I have used 0 to indicate an unknown number of books written
    //this is translated in the printDetails method
    ...
    public Author(String name, String address, int year, int month, int day, int booksWritten){
        super(name, address, year, month, day);
    ...
    public Author(String name, String address, int year, int month, int day,String language){
        super(name, address, year, month, day);
        this.booksWritten = 0;
        this.writtenLanguage = language;
    }

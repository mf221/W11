...
public class Author extends Person {
    ...
    /*if the number of books written is 0, logically this person 
    * cannot be an author so wouldn't exist in this class, therefore 
    * I have used 0 to indicate an unknown number of books written 
    ...
    public Author(String name, String address, int year, int month, int day, 
                  int booksWritten, String language){
        super(name, address, year, month, day);
        this.booksWritten = booksWritten;
